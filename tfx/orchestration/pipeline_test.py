...
class PipelineTest(tf.test.TestCase):
  ...
  def test_pipeline_with_artifact_info(self):
    ...
    channel_one = channel.Channel(
        ...
        static_artifact_collection=artifacts_collection)
    ...
    self.assertEqual(
        component_a.outputs.one._static_artifact_collection[0].pipeline_name,
        'a')
    self.assertEqual(
        component_a.outputs.one._static_artifact_collection[0]
        .producer_component, 'component_a.component_a')
    self.assertEqual(
        component_a.outputs.one._static_artifact_collection[0].name, 'one')
    self.assertEqual(
        component_b.inputs.a._static_artifact_collection[0]
        .pipeline_name, 'a')
    self.assertEqual(
        component_b.inputs.a._static_artifact_collection[0]
        .producer_component, 'component_a.component_a')
    self.assertEqual(
        component_b.inputs.a._static_artifact_collection[0].name, 'one')
